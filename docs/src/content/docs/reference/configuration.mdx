...
| ------------- | --------------------------------- | --------------------------------------------------- |
| `SiteTitle`   | <Badge text="Overridden" variant="note" />   | Renders the Nebari logo in the header. aoidjdjwhflajkhsfdglasdkjfh;aswdjfha;wlksjdfh;akwjsdfh;qwouehfq;wouefhwajefb;kasdjbf;ksjdabfg;kasjdbgfk;sadjbgsa;dfkjbgaskd;jbfvksajdbvlkjsdfbgkhjdsgfoaweuygfdvskudygvakeusd  |
...
| Variable                | Role                                  |
| ----------------------- | ------------------------------------- |
| `--sl-color-accent`     | Links, active states, primary buttons aohfdlaj kbfa;erjkb fggakj lsbgf;kaljsbflajkdbh sdjfhbgksjdhgfvajshgdf vashgjvdfajs hgdvfashg dfvash jdgvfs hdgv fsdhg|
